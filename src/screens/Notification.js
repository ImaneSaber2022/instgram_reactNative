    ...
    <View style={{width: '100%', height: '100%', backgroundColor: 'white'}}>
      ...
      <ScrollView style={{margin: 10}} showsVerticalScrollIndicator={false}>
        ...
        <View style={{flexDirection: 'row', paddingVertical: 10}}>
          {FriendsProfilData.slice(0.3).map((data, index) => {
            return (
              <TouchableOpacity
                onPress={() =>
                  navigation.push('FriendsProfil', {
                    name: data.name,
        ...
        {FriendsProfilData.slice(3.6).map((data, index) => {
        ...
        {FriendsProfilData.slice(6.12).map((data, index) => {
          const [follow, setFollow] = useState(data.follow);
        ...
        <View style={{padding: 20}}>
          <Text style={{color: '#3493D9'}}>see all seggestions</Text>
        </View>
      </ScrollView>
    </View>
  );
